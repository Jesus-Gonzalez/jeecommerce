...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Testimonio = __webpack_require__(169);

	var _Testimonio2 = _interopRequireDefault(_Testimonio);
	...
	var TestimoniosWrapper = function (_React$Component) {
	  _inherits(TestimoniosWrapper, _React$Component);

	  function TestimoniosWrapper() {
	    _classCallCheck(this, TestimoniosWrapper);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TestimoniosWrapper).call(this));

	    _this.state = {
	      testimonios: [{
	        nombre: 'Jesús G.',
	        imagen: 'autor.png',
	        testimonio: '1) Lorem ipsum dolor sit amet, consectetur adipisicing elit. Totam, iusto, modi.',
	        icono: 'fighter-jet'
	      }, {
	        nombre: 'Sir BSD',
	        imagen: 'amigo-freebsd.png',
	        testimonio: '2. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Totam, iusto, modi.',
	        icono: 'rocket'
	      }, {
	        nombre: 'Linus T.',
	        imagen: 'amigo.png',
	        testimonio: '3 -> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Totam, iusto, modi.',
	        icono: 'university'
	      }]
	    };
	    return _this;
	  ...
	  _createClass(TestimoniosWrapper, [{
	    key: 'render',
	    value: function render() {
	      var $testimonios = [];

	      for (var i = 0; i < this.state.testimonios.length; i++) {
	        $testimonios.push(_react2.default.createElement(_Testimonio2.default, { key: i, testimonio: this.state.testimonios[i] }));
	      }

	      return _react2.default.createElement(
	        'div',
	        { 'class': 'row intro-textos' },
	        $testimonios
	      );
	    }
	  }]);

	  return TestimoniosWrapper;
	}(_react2.default.Component);

	_reactDom2.default.render(_react2.default.createElement(TestimoniosWrapper, null), document.getElementById('testimonios-react'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Testimonio = function (_React$Component) {
	  _inherits(Testimonio, _React$Component);

	  function Testimonio() {
	    _classCallCheck(this, Testimonio);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Testimonio).apply(this, arguments));
	  }

	  _createClass(Testimonio, [{
	    key: "render",
	    value: function render() {
	      var testimonio = this.props.testimonio;

	      return _react2.default.createElement(
	        "section",
	        { className: "col-sm-4 col-xs-12 portada-caja destacado" },
	        _react2.default.createElement(
	          "div",
	          { className: "img-testimonio text-center" },
	          _react2.default.createElement("img", { src: "img/" + testimonio.imagen, className: "img-circle", width: "128", height: "128" })
	        ),
	        _react2.default.createElement(
	          "h2",
	          null,
	          testimonio.nombre,
	          " ",
	          _react2.default.createElement("i", { className: "fa fa-" + testimonio.icono })
	        ),
	        _react2.default.createElement(
	          "p",
	          null,
