				    ...
				    <div id="slc-tarjeta" class="panel-collapse collapse in">
				      <div class="panel-body">
								<div class='form-group'>
								  <label for='numero-tarjeta'>Número de tarjeta de crédito/debito</label>
								  <input id="numero-tarjeta" class="form-control" type="number" id="numero-tarjeta" placeholder="Número de la tarjeta" maxlength="20">
								</div>
								<div class='form-group'>
								  <label for='mes-caducidad-tarjeta'>Mes</label>
									<select id="mes-caducidad-tarjeta" class='form-control'>
									...
									<label id="lbl-ano-caducidad" for='ano-caducidad-tarjeta'>Año</label>
									<select id="ano-caducidad-tarjeta" class='form-control'>
								...
								<div class='form-group'>
								  <label for='name-id'>Código de seguridad</label>
								  <input id="cvc-tarjeta" type="password" name="codigo-seguridad" class="form-control" maxlength="5">
								</div>
				      </div>
				    </div>
				  </div>
